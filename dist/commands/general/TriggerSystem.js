...
const fileManagement_1 = require("../../helpers/fileManagement");
class TriggerSystem {
    ...
    getResponse(trigger) {
        let responses = this.getResponses(trigger);
        return responses[helpers_1.getRandomInt(responses.length)];
    }
...
function getTriggers() {
    return __awaiter(this, void 0, void 0, function* () {
        let triggerSystems = yield fileManagement_1.retrieve('./local/triggers', [], '.json');
...
function saveTriggerSystem(serverID) {
    return __awaiter(this, void 0, void 0, function* () {
        fileManagement_1.save(triggerSystemRecord[serverID], `./local/triggers/${serverID}.json`);
    });
}
